    ...
    return (
        ...
        flipSpeedFrontToBack ="0.8">
            <div className="effect7">
                ...
                <div id="content">
                    <Card style={{width:"23rem"}} className="bg-light text-dark">
                        <Card.Body>
                ...
                <div id="content">
                    <Card  style={{width:"23rem"}} className="bg-success text-light">
                        <Card.Body>
                ...
                <div id="content">
                    <Card  style={{width:"23rem"}} className="bg-danger text-light">
                        <Card.Body>
                ...
                <div className="effect7" >
                    <br/>
                    <h2 className="head2">Worldwide Cases</h2>
                    <div id="content">
                        <Card style={{width:"23rem"}} className="bg-light text-dark">
                            <Card.Body>
                                <Card.Header><h3> Total </h3></Card.Header>
